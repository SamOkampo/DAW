...
bool applyAssistantSuggestion(Project&p,const AssistantSuggestion&s,std::string&result){
 switch(s.action){
  ...
  case AssistantAction::Informational:result="This suggestion is informational and makes no automatic edit";return false;
 }

...
int main(int argc,char**argv){try{
    ...
    std::string error;auto found=scanPluginsWithJuce({bundle.parent_path()},error);require(error.empty(),"JUCE scan returned error");require(!found.empty(),"JUCE did not discover test VST3");

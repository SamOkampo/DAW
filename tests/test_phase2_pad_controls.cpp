...
int main(){
    try{
        ...
        require(loaded.formatVersion==11,"project must migrate/save as v11");
        require(loaded.samples.size()==1&&loaded.samples[0].slices.size()==2,"v11 slices must survive save/load");
        ...
        require(legacy.formatVersion==11,"v6 project must migrate to v11 in memory");

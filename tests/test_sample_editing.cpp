...
int main(){
    try{
        ...
        const auto originalThirdId=s.slices[2].id;
        ...
        require(s.slices[2].id==originalThirdId,"insert preserves original slice identity on left half");
        ...
        require(s.slices.size()==3&&s.slices[2].startFrame==2000&&s.slices[2].endFrame==3000,"remove merges the split third slice");

...
public:
    ...
    void resized()override{
        ...
        auto transport=r.removeFromTop(38);loadProject_.setBounds(transport.removeFromLeft(105).reduced(3));importWav_.setBounds(transport.removeFromLeft(105).reduced(3));saveProject_.setBounds(transport.removeFromLeft(110).reduced(3));play_.setBounds(transport.removeFromLeft(70).reduced(3));stop_.setBounds(transport.removeFromLeft(70).reduced(3));bpmMinus_.setBounds(transport.removeFromLeft(64).reduced(3));bpmLabel_.setBounds(transport.removeFromLeft(84).reduced(3));bpmPlus_.setBounds(transport.removeFromLeft(64).reduced(3));undoButton_.setBounds(transport.removeFromLeft(70).reduced(3));redoButton_.setBounds(transport.removeFromLeft(70).reduced(3));
        ...
        auto sampleTools=r.removeFromTop(38);analyzeSample_.setBounds(sampleTools.removeFromLeft(92).reduced(3));chop8_.setBounds(sampleTools.removeFromLeft(82).reduced(3));autoChop_.setBounds(sampleTools.removeFromLeft(98).reduced(3));chopBeat_.setBounds(sampleTools.removeFromLeft(98).reduced(3));chopBar_.setBounds(sampleTools.removeFromLeft(94).reduced(3));matchBpm_.setBounds(sampleTools.removeFromLeft(102).reduced(3));exportMix_.setBounds(sampleTools.removeFromLeft(100).reduced(3));exportStems_.setBounds(sampleTools.removeFromLeft(110).reduced(3));
        auto recordTools=r.removeFromTop(38);stopPreview_.setBounds(recordTools.removeFromLeft(100).reduced(3));recChops_.setBounds(recordTools.removeFromLeft(100).reduced(3));chopQuantize_.setBounds(recordTools.removeFromLeft(105).reduced(3));chopHumanize_.setBounds(recordTools.removeFromLeft(112).reduced(3));chopReset_.setBounds(recordTools.removeFromLeft(92).reduced(3));recAudio_.setBounds(recordTools.removeFromLeft(100).reduced(3));monitorInput_.setBounds(recordTools.removeFromLeft(92).reduced(3));prevTake_.setBounds(recordTools.removeFromLeft(82).reduced(3));nextTake_.setBounds(recordTools.removeFromLeft(82).reduced(3));

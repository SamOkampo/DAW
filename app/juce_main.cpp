...
public:
    MainComponent(){
        ...
        juceui::PluginRackPresentation::style(rackTargetChoice_,rackPluginChoice_,rackWet_,rackParam_,rackParamLabel_,rackMoveUp_,rackMoveDown_,rackEnabled_,rackBypass_,rackRemove_,openRackEditor_,shellLookAndFeel_);
    ...
    void resized()override{
        ...
        auto rack=r.removeFromTop(72);juceui::PluginRackPresentation::layout(rack,rackTargetChoice_,rackPluginChoice_,rackWet_,rackParam_,rackParamLabel_,rackMoveUp_,rackMoveDown_,rackEnabled_,rackBypass_,rackRemove_,openRackEditor_);

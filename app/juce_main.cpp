...
public:
    ...
    void resized()override{
        ...
        auto rack=r.removeFromTop(38);rackTargetChoice_.setBounds(rack.removeFromLeft(155).reduced(3));rackPluginChoice_.setBounds(rack.removeFromLeft(225).reduced(3));addRackGain_.setBounds(rack.removeFromLeft(98).reduced(3));addRackClip_.setBounds(rack.removeFromLeft(90).reduced(3));addRackWidth_.setBounds(rack.removeFromLeft(80).reduced(3));rackBypass_.setBounds(rack.removeFromLeft(72).reduced(3));rackRemove_.setBounds(rack.removeFromLeft(72).reduced(3));openRackEditor_.setBounds(rack.removeFromLeft(100).reduced(3));rackWet_.setBounds(rack.removeFromLeft(145).reduced(3));rackParamLabel_.setBounds(rack.removeFromLeft(68).reduced(3));rackParam_.setBounds(rack.reduced(3));
...
private:
    ...
    void syncRackControls(){
        suppressRackCallbacks_=true;auto*p=selectedRackPlugin();rackWet_.setEnabled(p!=nullptr);rackBypass_.setEnabled(p!=nullptr);rackRemove_.setEnabled(p!=nullptr);openRackEditor_.setEnabled(p&&p->format!="builtin");
